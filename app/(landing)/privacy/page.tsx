          ...
          <div className="prose prose-slate max-w-none">
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                המידע האישי שלך כאשר אתה משתמש בשירות תשובות AI. אנו מחויבים
                להגן על פרטיותך ולשמור על אבטחת המידע שלך.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed">
                אנו משתמשים באמצעי אבטחה מתקדמים כדי להגן על המידע שלך, כולל
                הצפנת נתונים, אימות OAuth 2.0 עם Google, ואחסון מאובטח ב-Firebase.
                עם זאת, שום שיטת העברה או אחסון אינה בטוחה ב-100%.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                לך יש את הזכויות הבאות בנוגע למידע האישי שלך:
              </p>
              <ul className="list-disc list-inside text-muted-foreground space-y-2 me-6">
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed">
                אנו משתמשים בקובצי Cookie ובטכנולוגיות דומות לשיפור חווית
                המשתמש, לניתוח תנועה באתר ולמטרות אבטחה. ניתן לנהל את העדפות
                ה-Cookie דרך הגדרות הדפדפן שלך.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed">
                אנו שומרים את המידע האישי שלך כל עוד חשבונך פעיל או כנדרש
                למטרות השירות. לאחר מחיקת החשבון, המידע יימחק בהתאם למדיניות
                השמירה שלנו ולדרישות החוק.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed">
                אנו עשויים לעדכן את מדיניות הפרטיות מעת לעת. נודיע לך על
                שינויים משמעותיים דרך האתר או בדוא"ל. המשך השימוש בשירות לאחר
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed">
                לשאלות או בקשות הנוגעות למדיניות הפרטיות או למימוש זכויותיך,
                ניתן ליצור קשר:
              </p>
