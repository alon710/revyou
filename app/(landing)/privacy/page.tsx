        ...
        <div className="prose prose-slate max-w-none">
          <section className="mb-8">
            ...
            <p className="text-muted-foreground leading-relaxed">
              מדיניות פרטיות זו מסבירה כיצד אנו אוספים, משתמשים ומגנים על המידע
              האישי שלך כאשר אתה משתמש בשירות תשובות AI. אנו מחויבים להגן על
              פרטיותך ולשמור על אבטחת המידע שלך.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground leading-relaxed">
              אנו משתמשים באמצעי אבטחה מתקדמים כדי להגן על המידע שלך, כולל הצפנת
              נתונים, אימות OAuth 2.0 עם Google, ואחסון מאובטח ב-Firebase. עם
              זאת, שום שיטת העברה או אחסון אינה בטוחה ב-100%.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground leading-relaxed">
              אנו משתמשים בקובצי Cookie ובטכנולוגיות דומות לשיפור חווית המשתמש,
              לניתוח תנועה באתר ולמטרות אבטחה. ניתן לנהל את העדפות ה-Cookie דרך
              הגדרות הדפדפן שלך.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground leading-relaxed">
              אנו שומרים את המידע האישי שלך כל עוד חשבונך פעיל או כנדרש למטרות
              השירות. לאחר מחיקת החשבון, המידע יימחק בהתאם למדיניות השמירה שלנו
              ולדרישות החוק.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground leading-relaxed">
              לשאלות או בקשות הנוגעות למדיניות הפרטיות או למימוש זכויותיך, ניתן
              ליצור קשר:
            </p>
