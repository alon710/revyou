...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "המערכת משתמשת באינטגרציה רשמית של Google Location Profile API עם OAuth 2.0, כך שאנחנו לא שומרים את סיסמת Google שלך. כל המידע מוצפן ומאוחסן באופן מאובטח ב-Firebase של Google. אנחנו עומדים בסטנדרטים הגבוהים ביותר של אבטחת מידע ופרטיות.",
  },
  {
