  ...
  const handleCheckout = async (product: EnrichedProduct) => {
    ...
    try {
      ...
      const redirectUrl = priceId
        ? `/checkout?plan=${product.planId}&period=${billingPeriod}&priceId=${priceId}&success_url=${encodeURIComponent(`${window.location.origin}/onboarding/step-2`)}&cancel_url=${encodeURIComponent(`${window.location.origin}/onboarding/step-1`)}`
        : `/checkout?plan=${product.planId}&period=${billingPeriod}&success_url=${encodeURIComponent(`${window.location.origin}/onboarding/step-2`)}&cancel_url=${encodeURIComponent(`${window.location.origin}/onboarding/step-1`)}`;
